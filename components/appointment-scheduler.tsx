...
import { Calendar, Phone, MessageCircle, CheckCircle, ArrowLeft, ArrowRight } from "lucide-react"
        ...
        {currentStep !== "booking" && (
          <div className="flex justify-between mt-8">
            ...
            <Button
              onClick={handleNext}
              disabled={
                (currentStep === "select-type" && !appointmentType) ||
                (currentStep === "choose-time" && (!selectedDate || !selectedTime)) ||
                (currentStep === "patient-info" && !reason.trim())
              }
